                      ...
                      <div className="flex flex-col gap-2">
                        <Label htmlFor="icon" className="flex flex-col gap-0.5">
                          ...
                          <span className="text-xs text-gray-500">
                            <span>
                              Icon of the module in the sidebar. This is used to
                              display the icon of the module in the sidebar.
                            </span>
                            <a
                    ...
                    <div className="grid">
                      <div className="flex flex-col gap-2">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setData("group_title", e.target.value)
                          }
                          disabled={processing}
            ...
            customData={[
              {
                key: "order",
                render: (module) => (
                  <span className="text-center">{module.order}</span>
                ),
              },
              {
                key: "icon",
              ...
              },
              {
                ...
                render: (module) =>
                  module.path ? (
                    <Badge variant={"outline"}>{module.path}</Badge>
                  ) : (
                    <span className="text-gray-500">No path</span>
                  ),
              },
              {
                key: "is_client",
                render: (module) =>
                  module.is_client ? <span>Client</span> : <span>Admin</span>,
              },
              {
                key: "parent_name",
                render: (module) =>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  ...
                  module and all of its data.
                </DialogDescription>
                <DialogFooter>
                  <Button
                    type="submit"
                    variant={"danger"}
                    onClick={() => deleteModule(idToDelete)}
                  >
                    Yes
                  </Button>
                </DialogFooter>
