          ...
          <div className="flex items-center justify-between p-4 px-4">
            <div className="flex w-full items-center justify-between">
              <Link href="/" prefetch className="flex items-center space-x-3">
                <AppLogo
                  companyClassName="text-white text-[15px]"
                  appnameClassName="text-gray-200 text-[12px]"
                />
              </Link>
              ...
              <NavigationMenu className="flex h-full items-stretch">
                <NavigationMenuList className="relative flex h-full items-stretch space-x-2">
                  {mainNavItems.map((item, index) => {
                    const isActive = item.routes?.some((r) =>
                      r === "/" ? page.url === "/" : page.url.startsWith(r)
                    );
                    return (
                      <NavigationMenuItem
                        key={index}
                      ...
                      >
                        <Link
                          ...
                          className={cn(
                            ...
                            isActive &&
                              "text-[#3b5998] dark:bg-[#151515] dark:text-[#6393fa]"
                          )}
                        >
                          {item.icon && (
                            <Icon
